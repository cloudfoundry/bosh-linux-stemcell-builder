...
mkdir $chroot/usr/src/ixgbevf-4.2.2

tar -xzf $assets_dir/ixgbevf-4.2.2.tar.gz \
  -C $chroot/usr/src/ixgbevf-4.2.2 \
  --strip-components=1

cp $assets_dir/usr/src/ixgbevf-4.2.2/dkms.conf $chroot/usr/src/ixgbevf-4.2.2/dkms.conf
