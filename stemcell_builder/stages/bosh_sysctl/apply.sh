...
if [ "${stemcell_operating_system_version}" == "trusty" -o "${stemcell_operating_system_version}" == "7" -o "${stemcell_operating_system}" == "photonos" -o "${stemcell_operating_system}" ==  "opensuse" ]; then
