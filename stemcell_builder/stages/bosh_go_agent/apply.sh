...
cd $assets_dir
if is_ppc64le; then
  curl -L -o bosh-agent "https://s3.amazonaws.com/bosh-agent-binaries/bosh-agent-2.8.3-linux-ppc64le?versionId=IuFiaMrUvwJxqHg.HJZwNX1r8L3Ezl4_"
  echo "1949e8e6dec95932183631b69919568c87776902b244ecb530f2876f4d6f0bf5  bosh-agent" | shasum -a 256 -c -
else
