...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/bosh-agent-binaries/bosh-agent-2.117.3-linux-amd64"
  echo "5ce5bf5e44b3fc43a668c743fb53da2b863ada190c19d3fb1a6b04afde169b32  bosh-agent" | shasum -a 256 -c -
fi
