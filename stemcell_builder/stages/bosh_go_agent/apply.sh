...
if is_ppc64le; then
  ...
  echo "349d40640e0fe03f33c1416cf3d6c4a79a478a6b016e6c445eaafd6a9ac51e9c" | shasum -a 256 -c -
else
  ...
  echo "3b49afd131460c3be06fdca68616cea5e23e987b3f82a222cbf08350e5ff53a8" | shasum -a 256 -c -
fi
