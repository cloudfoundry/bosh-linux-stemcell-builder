...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/bosh-agent-binaries/bosh-agent-2.106.0-linux-amd64"
  echo "adaa4389f478fca0e1ce06633d486f948efe58b09951fb9d460f3fd49f0632ec  bosh-agent" | shasum -a 256 -c -
fi
