module github.com/cloudfoundry/stemcell-acceptance-tests
...
require (
	...
	golang.org/x/sys v0.0.0-20171129155245-316e9227019b
	golang.org/x/text v0.1.1-0.20171128102810-572a2b141f62
