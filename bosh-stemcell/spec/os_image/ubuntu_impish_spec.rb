...
describe 'Ubuntu 21.10 OS image', os_image: true do
  ...
  describe 'base_apt' do
    describe file('/etc/apt/sources.list') do
      its(:content) { should match 'deb http://archive.ubuntu.com/ubuntu impish main universe multiverse' }
      its(:content) { should match 'deb http://archive.ubuntu.com/ubuntu impish-updates main universe multiverse' }
      its(:content) { should match 'deb http://security.ubuntu.com/ubuntu impish-security main universe multiverse' }
    end
