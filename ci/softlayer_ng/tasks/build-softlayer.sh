...
: "${IAAS:?You must set IAAS non-empty}"
: "${HYPERVISOR:?You must set HYPERVISOR non-empty}"
: "${OS_NAME:?You must set OS_NAME non-empty}"
: "${OS_VERSION:?You must set OS_VERSION non-empty}"
# optional
: "${BOSHIO_TOKEN?You must set OS_VERSION}"
...
echo -e "\n\033[32m[INFO] Building stemcell.\033[0m"
